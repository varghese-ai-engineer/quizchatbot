...
def _lang_feedback_rules(language: str) -> str:
    if language == "ta":
        return (
            ...
            "  Pattern: தவறு. Correct answer [correct_answer] தான்.\n"
            "  Example: தவறு. Correct answer MS Dhoni தான்.\n"
            "  Example: தவறு. Correct answer Python தான்.\n"
            "  IMPORTANT: Do NOT write 'not [student_answer]' — the student's answer\n"
            "  may be an abbreviation or alias of the correct answer.\n\n"
    ...
    if language == "hi":
        return (
            ...
            "  Example: गलत. Correct answer MS Dhoni है.\n"
            "  Example: गलत. Correct answer Python है.\n"
            "  IMPORTANT: Do NOT write 'not [student_answer]'.\n\n"
